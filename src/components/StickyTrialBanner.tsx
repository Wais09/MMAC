        ...
        <div className="container mx-auto px-3 sm:px-4 py-3 sm:py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-2 sm:space-x-3">
              <div className="flex items-center space-x-1 sm:space-x-2">
                <Star className="w-4 h-4 sm:w-5 sm:h-5 text-black fill-current" />
                <span className="font-bold text-base sm:text-lg">FREE TRIAL CLASS</span>
              </div>
            ...
            <div className="flex items-center space-x-2 sm:space-x-4">
              <Button
                ...
                className="bg-black hover:bg-gray-800 text-yellow-400 font-bold px-4 sm:px-6 py-2 sm:py-3 text-sm sm:text-base shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 rounded-lg"
              >
                BOOK NOW
              </Button>
              ...
              <Button
                ...
                className="hidden sm:flex items-center bg-white/20 hover:bg-white/30 backdrop-blur-sm text-black font-semibold px-3 sm:px-4 py-2 rounded-lg transition-all duration-300 border-0 text-sm sm:text-base"
              >
                📞 Call Now
              </Button>
            </div>
            ...
            <Button
              ...
              className="text-black hover:bg-black/10 p-1 rounded-full ml-1 sm:ml-2 min-w-[32px] h-8"
          ...
          <div className="sm:hidden mt-3 text-center">
            <div className="flex items-center justify-center space-x-3 text-sm">
              ...
              <button
                onClick={handleCallClick}
                className="font-semibold underline bg-transparent border-0 p-0 text-black hover:text-gray-800 transition-colors"
              >
                📞 (042) 311 1999
              </button>
            </div>
