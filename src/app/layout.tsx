  ...
  return (
    <html lang="en" className={`${geistSans.variable} ${geistMono.variable}`}>
      <head>
        ...
        <meta name="apple-mobile-web-app-title" content="MMAC" />
        <link rel="apple-touch-icon" href="/icons/icon-192x192.png" />

        {/* Theme Colors */}
        <meta name="theme-color" content="#eec248" />
        <meta name="msapplication-TileColor" content="#eec248" />
        <meta name="msapplication-config" content="/browserconfig.xml" />

        {/* Preload Critical Resources */}
        <link rel="preload" href="/logo.png" as="image" type="image/png" />
        <link rel="preload" href="https://img.youtube.com/vi/-I544tzhNgw/maxresdefault.jpg" as="image" type="image/jpeg" />

        {/* DNS Prefetch for External Resources */}
        <link rel="dns-prefetch" href="//fonts.googleapis.com" />
        <link rel="dns-prefetch" href="//www.youtube.com" />
        <link rel="dns-prefetch" href="//app.clubworx.com" />
