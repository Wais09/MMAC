    ...
    <section className="relative h-screen bg-gray-900 overflow-hidden">
      ...
      <div className="relative container mx-auto px-4 h-full flex items-center z-10">
        <div className="max-w-2xl text-white">
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-4 lg:mb-6 leading-tight drop-shadow-lg">
            Train with the Best
          </h1>
          <p className="text-base sm:text-lg md:text-xl mb-6 lg:mb-8 font-medium leading-relaxed drop-shadow-md">
          ...
          <div className="flex flex-col sm:flex-row gap-3 lg:gap-4">
            <Button
              className="bg-yellow-400 hover:bg-yellow-500 text-black font-bold px-6 lg:px-8 py-3 text-base lg:text-lg rounded-md transition-all duration-300 transform hover:scale-105 shadow-lg"
            ...
            <Button
              variant="outline"
              className="border-white text-white hover:bg-white hover:text-black font-bold px-6 lg:px-8 py-3 text-base lg:text-lg rounded-md transition-all duration-300 shadow-lg"
    ...
    <section id="about" className="py-16 lg:py-20 bg-white">
      <div className="container mx-auto px-4">
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12">
          <div>
            <h2 className="text-2xl lg:text-3xl font-bold text-gray-900 mb-4 lg:mb-6">MMAC</h2>
          ...
          <div>
            <h2 className="text-2xl lg:text-3xl font-bold text-gray-900 mb-4 lg:mb-6">OUR MISSION</h2>
            <p className="text-gray-700 mb-4 lg:mb-6 leading-relaxed">
