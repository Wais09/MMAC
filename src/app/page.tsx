...
import OptimizedImage, { generateBlurDataURL } from "@/components/OptimizedImage"
    ...
    <section className="relative h-screen bg-gray-900 overflow-hidden">
      ...
      <div className="relative container mx-auto px-4 h-full flex items-center z-10">
        <div className="max-w-2xl text-white w-full">
          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold mb-4 sm:mb-6 lg:mb-8 leading-tight drop-shadow-2xl">
            Train with the Best
          </h1>
          <p className="text-lg sm:text-xl md:text-2xl mb-6 sm:mb-8 lg:mb-10 font-medium leading-relaxed drop-shadow-lg max-w-xl">
          ...
          <div className="flex flex-col sm:flex-row gap-4 lg:gap-6">
            <Button
              className="bg-yellow-400 hover:bg-yellow-500 text-black font-bold px-8 lg:px-10 py-4 lg:py-5 text-lg lg:text-xl rounded-lg transition-all duration-300 transform hover:scale-105 shadow-xl border-0 min-h-[56px] sm:min-h-[60px]"
            ...
            <Button
              variant="outline"
              className="border-2 border-white text-white hover:bg-white hover:text-black font-bold px-8 lg:px-10 py-4 lg:py-5 text-lg lg:text-xl rounded-lg transition-all duration-300 shadow-xl min-h-[56px] sm:min-h-[60px]"
    ...
    <section id="about" className="py-16 sm:py-20 lg:py-24 bg-white">
      <div className="container mx-auto px-4">
        <div className="grid lg:grid-cols-2 gap-10 lg:gap-16">
          <div>
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-gray-900 mb-6 lg:mb-8">MMAC</h2>
          ...
          <div>
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-gray-900 mb-6 lg:mb-8">OUR MISSION</h2>
            ...
            <Link href="/about">
              <Button
                variant="outline"
                className="border-2 border-yellow-400 text-yellow-400 hover:bg-yellow-400 hover:text-black font-bold px-6 py-3 text-lg transition-all duration-300 hover:scale-105"
              >
                LEARN MORE
              </Button>
            </Link>
    ...
    <section className="py-16 lg:py-20 bg-gray-50">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12 lg:mb-16">
          ...
          <h2 className="text-3xl lg:text-4xl font-bold text-gray-900">FOR YOU</h2>
        </div>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
          {styles.map((style, index) => (
            <Link key={style.title} href={style.href} className="block">
              <Card className="overflow-hidden hover:shadow-lg transition-all duration-300 hover:scale-105 cursor-pointer transform-gpu will-change-transform h-full">
                <div className="relative h-48 sm:h-56 lg:h-48">
                  <OptimizedImage
                    ...
                    style={{
                      objectPosition: style.title === "Brazilian Jiu Jitsu (BJJ)" ? '50% 25%' :
                                    style.title === "Kids" ? '50% 20%' : 'center'
                    }}
                    priority={index < 3}
                    quality={85}
                    sizes="(max-width: 640px) 100vw, (max-width: 1024px) 50vw, 33vw"
                    blurDataURL={generateBlurDataURL(style.image)}
                    placeholder="blur"
                  />
                ...
                <CardContent className="p-4 lg:p-6 flex-1">
                  <h3 className="font-bold text-lg lg:text-xl text-gray-900 mb-3 group-hover:text-yellow-500 transition-colors">{style.title}</h3>
                  <p className="text-gray-600 text-sm lg:text-base leading-relaxed">{style.description}</p>
                </CardContent>
              </Card>
            </Link>
          ))}
        ...
        <div className="text-center mt-8 lg:mt-12">
          <Link href="/styles">
            <Button variant="outline" className="border-yellow-400 text-yellow-400 hover:bg-yellow-400 hover:text-black px-6 lg:px-8 py-3">
              VIEW ALL STYLES
            </Button>
          </Link>
        </div>
      ...
      <div className="container mx-auto px-4">
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          <div>
            ...
            <h2 className="text-3xl lg:text-4xl font-bold text-black mb-4 lg:mb-6">Every Great Journey Starts with One Step!</h2>
            <p className="text-black mb-6 lg:mb-8 leading-relaxed">
              Experience a complimentary week of our classes — come and give it a try at no cost!
            </p>
            <div className="flex flex-col sm:flex-row gap-3 lg:gap-4">
              <Link href="/contact">
                <Button className="bg-blue-500 hover:bg-blue-600 text-white px-6 lg:px-8 py-3">
                  BOOK NOW
                </Button>
              </Link>
              <Link href="/timetable">
                <Button variant="outline" className="border-black text-black hover:bg-black hover:text-white px-6 lg:px-8 py-3">
                  CHECK TIMETABLE
                </Button>
              </Link>
            </div>
          ...
          <div>
            ...
            <h3 className="text-xl lg:text-2xl font-bold text-black mb-4 lg:mb-6">We Can help you with following:</h3>
    ...
    <section className="py-16 lg:py-20 bg-gray-50">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12 lg:mb-16">
          ...
          <h2 className="text-3xl lg:text-4xl font-bold text-gray-900">Learn More From</h2>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-400">
              ...
              <li><Link href="/styles" className="hover:text-yellow-400 transition-colors">Styles</Link></li>
              <li><Link href="/coaches" className="hover:text-yellow-400 transition-colors">Coaches</Link></li>
              <li><Link href="/blog" className="hover:text-yellow-400 transition-colors">Blog</Link></li>
              <li><Link href="/timetable" className="hover:text-yellow-400 transition-colors">TimeTable</Link></li>
              <li><Link href="/gallery" className="hover:text-yellow-400 transition-colors">Gallery</Link></li>
              <li><Link href="/membership" className="hover:text-yellow-400 transition-colors">Membership / Pricing</Link></li>
              <li><Link href="/socials" className="hover:text-yellow-400 transition-colors">Our Socials</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-400">
              <li><a href="/styles/mma" className="hover:text-yellow-400 transition-colors">MMA</a></li>
              <li><a href="/styles/muay-thai" className="hover:text-yellow-400 transition-colors">MUAY THAI</a></li>
              <li><a href="/styles/kids" className="hover:text-yellow-400 transition-colors">Kids</a></li>
              <li><a href="/styles/bjj" className="hover:text-yellow-400 transition-colors">BJJ</a></li>
              <li><a href="/styles/wrestling" className="hover:text-yellow-400 transition-colors">Wrestling</a></li>
            </ul>
          </div>
            ...
            <div className="flex space-x-3 mt-4">
              <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" className="hover:scale-110 transition-transform duration-200">
                <Image
                  ...
                  width={24}
                  height={24}
                  className="w-6 h-6 hover:opacity-80 cursor-pointer filter brightness-75 hover:brightness-100 transition-all duration-200"
                />
              </a>
              ...
              <a href="https://tiktok.com" target="_blank" rel="noopener noreferrer" className="hover:scale-110 transition-transform duration-200">
                <Image
                  ...
                  width={24}
                  height={24}
                  className="w-6 h-6 hover:opacity-80 cursor-pointer transition-all duration-200"
                />
              </a>
            </div>
          </div>
